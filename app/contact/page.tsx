            ...
            <div className="flex flex-col">
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="flex flex-col flex-1 gap-5">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-orange-500 hover:bg-orange-600 text-white font-bold py-3.5 px-6 rounded-full transition-colors text-base mt-auto"
            ...
            <div className="flex flex-col">
              ...
              <div className="flex flex-col flex-1 gap-5">
                ...
                <a
                  ...
                  className="flex items-center justify-center gap-3 bg-green-500 hover:bg-green-600 text-white font-bold py-3.5 px-6 rounded-full transition-colors w-full text-base mt-auto"
                  style={{ borderRadius: '9999px' }}
                >
